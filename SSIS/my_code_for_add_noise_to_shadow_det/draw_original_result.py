# @File: SSIS/my_code_for_add_noise_to_shadow_det/draw_original_result.py
# @Author: cws 
# @Create Date: 2024/02/28
# @Desc: Draw the model's original det/seg result.
...
def main():
    ...
    original_result = "my_shadow_det/original_boxinst_result/reid_one_class_infer_pair_warp_right_track_reid_eval_in_train/long_epoch_seq_shuffle_fl_2_lr_0_0001_bs_4_eval_40_ckpt_500_steps_4k/inference/iter_0002839/coco_instances_results.json"
    img_out_dir = os.path.join("vis_shadow_result/model_original_result_no_use_shadow/", seq_name)
    os.makedirs(img_out_dir, exist_ok=True)
    shadow_out_path = os.path.join(img_out_dir, img_name+"_original_result.png")
    shadow_content = load_json(original_result)
