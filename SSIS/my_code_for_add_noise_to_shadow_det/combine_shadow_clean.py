...
json_outpath = 'my_shadow_det/combine_clean_shadow_with_boxmots_result/reid_one_class_infer_pair_warp_right_track_reid_eval_in_train/long_epoch_seq_shuffle_fl_2_lr_0_0001_bs_4_eval_40_ckpt_500_steps_4k/inference/iter_0002839/shadow_filter_result_rate_0'+str(int(shadow_rate_th*10))+'.json'
