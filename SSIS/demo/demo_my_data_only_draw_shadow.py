...
from predictor import VisualizationDemoOnlyUseShadow
...
def get_parser():
    ...
    parser.add_argument(
        "--output",
        default="./my_vis_result/kitti_mots_val_only_draw_shadow/",
...
if __name__ == "__main__":
    ...
    demo = VisualizationDemoOnlyUseShadow(cfg)
    result_all_img = []
    if args.input:
        ...
        # save json to disk.
        # json_out_dir = './my_json_result/kitti_mots_val/'
