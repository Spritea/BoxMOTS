...
from adet.evaluation import SOBAEvaluator
...
register_soba_instances("kitti_mots_train_in_trainval", {"thing_classes" :["car","pedestrian"]}, "../../my_dataset/KITTI_MOTS/annotations/train_in_trainval_gt_as_coco_instances.json", "../../my_dataset/KITTI_MOTS/imgs/train_in_trainval/")
register_soba_instances("kitti_mots_val_in_trainval", {"thing_classes" :["car","pedestrian"]}, "../../my_dataset/KITTI_MOTS/annotations/val_in_trainval_gt_as_coco_instances.json", "../../my_dataset/KITTI_MOTS/imgs/val_in_trainval/")
...
if __name__ == "__main__":
    ...
    if args.num_gpus == 1:
        ...
        dist.init_process_group('gloo', init_method='file:///tmp/somefile{}'.format(np.random.randint(0,99999,1)), rank=0, world_size=1)
