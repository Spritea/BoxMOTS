...
if __name__ == "__main__":
    ...
    outdir = "for_tracking/my_output/combine_noisy_shadow_with_boxmots_result/shadow_filter_result_rate_02_erode_kernel_11_iter_1/mots_det_seg/val_in_trainval/"
