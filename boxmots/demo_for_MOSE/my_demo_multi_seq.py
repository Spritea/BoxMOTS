# @File: AdelaiDet/demo_for_MOSE/my_demo_multi_seq.py 
# @Author: cws 
# @Create Date: 2024/02/23
# @Desc: To infer on multiple seqs of MOSE,
...
if __name__ == "__main__":
    ...
    dataset_dir = "MOSE_car_seq/valid_car_seq"
    ...
    for seq_one in tqdm(seq_list):
        ...
        img_output_dir = os.path.join(seq_one_path.replace("MOSE_car_seq", "MOSE_car_seq_out_no_pair_warp"),"img_out")
        reid_output_dir = os.path.join(seq_one_path.replace("MOSE_car_seq", "MOSE_car_seq_out_no_pair_warp"),"reid_out")
        json_output_dir = os.path.join(seq_one_path.replace("MOSE_car_seq", "MOSE_car_seq_out_no_pair_warp"),"coco_json_out")
