# This file predictor.py is copied from demo/predictor.py.
...
# below by cws.
from .my_defaults import DefaultPredictorReID

class VisualizationDemoReID(object):
    def __init__(self, cfg, instance_mode=ColorMode.IMAGE, parallel=False):
        ...
        if parallel:
            ...
            self.predictor = DefaultPredictorReID(cfg)
    ...
    def run_on_image(self, image):
        ...
        vis_output = visualizer.draw_instance_predictions(predictions=instances)
        reid_feature = predictions[1]

        return predictions[0], vis_output, reid_feature
