...
from adet.data.dataset_mapper import YTVIS2019DatasetMapperWithBasisReIDOptFlowRightAugRightTrack, YTVIS2019DatasetMapperWithBasisReIDEval
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.MODEL.FCPOSE_ON:
            ...
            mapper = YTVIS2019DatasetMapperWithBasisReIDOptFlowRightAugRightTrack(cfg, True)
