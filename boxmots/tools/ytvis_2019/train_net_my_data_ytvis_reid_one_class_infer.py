...
from adet.data.dataset_mapper import YTVIS2019DatasetMapperWithBasisReID
...
# directly use the bdd_register_coco_instances_reid, 
# since the converted youtube-vis label has the same format with bdd label.
