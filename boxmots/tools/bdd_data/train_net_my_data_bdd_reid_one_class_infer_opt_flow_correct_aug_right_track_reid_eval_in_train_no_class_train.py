...
from adet.data.dataset_mapper import BDDDatasetMapperWithBasisReIDOptFlowRightAugRightTrack,BDDDatasetMapperWithBasisReIDEval
...
from my_code.my_evaluator import BDDReIDInferAndEvalInTrainClassSeven
# below by cws.
...
bdd_register_coco_instances_reid("bdd_mots_train_no_class_train", {"thing_classes" :["pedestrian","rider","car","truck","bus","motorcycle","bicycle"]}, "my_dataset/bdd100k/labels/seg_track_20/from_rles/train_seg_track_no_class_train.json", "my_dataset/bdd100k/images/seg_track_20/train/")
bdd_register_coco_instances_reid("bdd_mots_val_no_class_train", {"thing_classes" :["pedestrian","rider","car","truck","bus","motorcycle","bicycle"]}, "my_dataset/bdd100k/labels/seg_track_20/from_rles/val_seg_track_no_class_train.json", "my_dataset/bdd100k/images/seg_track_20/val/")
a=MetadataCatalog.get("bdd_mots_train")
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.MODEL.FCPOSE_ON:
            ...
            mapper = BDDDatasetMapperWithBasisReIDOptFlowRightAugRightTrack(cfg, True)
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        reid_evaluator=BDDReIDInferAndEvalInTrainClassSeven(output_dir=output_folder)
    ...
    def build_test_loader(cls, cfg, dataset_name):
        mapper = BDDDatasetMapperWithBasisReIDEval(cfg, is_train=False)
