...
from adet.data.dataset_mapper import DatasetMapperWithBasisReID,DatasetMapperWithBasisReIDEval
...
from my_code.my_evaluator import ReIDEvalInTrain
# below by cws.
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.MODEL.FCPOSE_ON:
            ...
            mapper = DatasetMapperWithBasisReID(cfg, True)
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        reid_evaluator=ReIDEvalInTrain(output_dir=output_folder)
