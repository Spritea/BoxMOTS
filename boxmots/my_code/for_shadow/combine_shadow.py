...
boxinst_filepath = "../../my_shadow_det/original_boxinst_result/reid_one_class_infer_pair_warp_right_track_reid_eval_in_train/imagenet_pretrain/long_epoch_seq_shuffle_fl_2_lr_0_01_bs_4_eval_500_no_color_sim_pretrain_weights_v2/iter_0008499/coco_instances_results.json"
...
json_outpath = '../../my_shadow_det/filter_result/reid_one_class_infer_pair_warp_right_track_reid_eval_in_train/imagenet_pretrain/long_epoch_seq_shuffle_fl_2_lr_0_01_bs_4_eval_500_no_color_sim_pretrain_weights_v2/iter_0008499/shadow_filter_result_rate_0'+str(int(shadow_rate_th*10))+'.json'
