...
def get_pkl_and_del_nan_by_category(file_name,category='both'):
...
if __name__=='__main__':
    ...
    file_name="../../training_dir/reid_one_class_infer_pair_warp/COCO_pretrain_strong/search_for_loss_combination/long_epoch_seq_shuffle_fl_2_lr_0_0001_bs_4_eval_500_no_color_sim_pretrain_weights_v2/BoxInst_MS_R_50_1x_kitti_mots/reid_eval_dir/iter_0003999/reid_eval_out/reid_eval_out.pkl"
    print('all reid eval:')
    track_id_np,reid_feat_np=get_pkl_and_del_nan_by_category(file_name)
    run_reid_eval(track_id_np,reid_feat_np)
    print('car reid eval:')
    track_id_np_car,reid_feat_np_car=get_pkl_and_del_nan_by_category(file_name,category='car')
    run_reid_eval(track_id_np_car,reid_feat_np_car)
    print('ped reid eval:')
    track_id_np_ped,reid_feat_np_ped=get_pkl_and_del_nan_by_category(file_name,category='ped')
    run_reid_eval(track_id_np_ped,reid_feat_np_ped)
