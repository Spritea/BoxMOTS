...
# below by cws.
from .reid_one_class_infer_and_eval_pair_triplet_branch import build_reid_branch
...
class CondInst_ReID_One_Class_Infer_ReID_Eval_In_Train_Pair_Triplet(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if "instances" in batched_inputs[0]:
            ...
            if self.boxinst_enabled:
                ...
                # add self.training condition
                # since gt_instances could contain empty label, like iscrowd,
                # they are not removed in test stage, they would only be removed in train stage.
                # then per_im_gt_inst.gt_bitmasks = torch.stack(per_im_bitmasks, dim=0) would cause error.
                if self.training:
