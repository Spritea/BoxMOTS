...
# below by cws.
from .reid_one_class_gt_mask_pool_eval_branch import build_reid_branch


__all__ = ["CondInst_ReID_One_Class_GT_Mask_Pool_Eval"]
...
class CondInst_ReID_One_Class_GT_Mask_Pool_Eval(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            reid_feat=self.reid_branch(features,gt_instances=gt_instances)
            return reid_feat
