...
# below by cws.
from .reid_sem_hard_branch import build_reid_branch


__all__ = ["CondInst_ReID_Sem_Hard"]
...
class CondInst_ReID_Sem_Hard(nn.Module):
    """
    Main class for CondInst+ReID+Sem Hard architectures.
    """
