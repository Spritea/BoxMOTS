...
from .dynamic_mask_head_pair_warp_inverse import build_dynamic_mask_head
...
class CondInst_ReID_One_Class_Infer_Pair_Warp_Inverse_ReID_Eval_In_Train(nn.Module):
    """
