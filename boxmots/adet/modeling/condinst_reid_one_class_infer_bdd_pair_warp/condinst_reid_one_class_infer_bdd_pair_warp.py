...
__all__ = ["CondInst_ReID_One_Class_Infer_BDD_Pair_Warp"]
...
class CondInst_ReID_One_Class_Infer_BDD_Pair_Warp(nn.Module):
    """
        ...
        if self.training:
            ...
            for im_id, (input_per_image, image_size) in enumerate(zip(batched_inputs, images_norm.image_sizes)):
                ...
                reid_out = self.reid_branch(
                    features, pred_instances=instances_per_im_for_backbone)
