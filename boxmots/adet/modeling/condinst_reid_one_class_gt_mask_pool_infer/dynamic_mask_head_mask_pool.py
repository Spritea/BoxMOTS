...
class DynamicMaskHead(nn.Module):
    ...
    def mask_heads_forward_with_coords(
        ...
        # below added by cws.
        # make the DynamicMaskHead class
        # get mask output with same size as the feature input of reid mask pool branch.
        mask_out_stride_reid=8
        mask_logits_copy=mask_logits.clone().detach()
        mask_logits_reid=aligned_bilinear(mask_logits_copy,int(mask_feat_stride/mask_out_stride_reid))
        self.mask_score_reid=mask_logits_reid.sigmoid()
