...
# below by cws.
from .reid_one_class_gt_mask_pool_infer_reid_eval_branch import build_reid_branch


__all__ = ["CondInst_ReID_One_Class_GT_Mask_Pool_Infer"]
...
class CondInst_ReID_One_Class_GT_Mask_Pool_Infer_ReID_Eval(nn.Module):
    """
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            for im_id, (input_per_image, image_size) in enumerate(zip(batched_inputs, images_norm.image_sizes)):
                ...
                # get reid feat based on gt mask below,
                # for reid eval in training stage.
                reid_out=self.reid_branch(features,gt_instances=gt_instances)
