# @File: AdelaiDet/demo_for_ytvis_2019/my_demo_multi_seq_ytvis.py 
# @Author: cws 
# @Create Date: 2024/04/18
# @Desc: To infer on multiple seqs of YouTube-VIS-2019,
# and get the coco json, reid feat, and img output.
# Based on demo_for_MOSE/my_demo_multi_seq.py.
...
if __name__ == "__main__":
    ...
    # args.config_file = "../configs/YTVIS_2019/BoxInst_ReID_One_Class_Infer_Right_Track_ReID_Eval_In_Train_For_Infer/MS_R_50_1x_ytvis_2019_coco_pretrain_strong_iter_90k_seq_shuffle_fl_2_lr_0_001_bs_16_eval_500_for_infer.yaml"
    # args.opts = ["MODEL.WEIGHTS", "../training_dir_ytvis_2019/reid_one_class_infer_right_track_reid_eval_in_train/COCO_pretrain_strong/iter_90k_seq_shuffle_fl_2_lr_0_001_bs_16_eval_500/BoxInst_MS_R_50_1x_kitti_mots/model_0089999.pth"]
    
    # below for pair warp.
    args.config_file = "../configs/YTVIS_2019/BoxInst_ReID_One_Class_Infer_YTVIS_Pair_Warp_ReID_Eval_In_Train_For_Infer/MS_R_50_1x_ytvis_2019_coco_pretrain_strong_iter_30k_seq_shuffle_fl_2_lr_0_0001_bs_4_eval_500_no_color_sim_pretrain_weights_v2_for_infer.yaml"
    args.opts = ["MODEL.WEIGHTS", "../training_dir_ytvis_2019/reid_one_class_infer_ytvis_pair_warp_right_track_reid_eval_in_train/COCO_pretrain_strong/iter_30k_seq_shuffle_fl_2_lr_0_0001_bs_4_eval_500_no_color_sim_pretrain_weights_v2/BoxInst_MS_R_50_1x_kitti_mots/model_0029999.pth"]
    ...
    for seq_one in tqdm(seq_list):
        ...
        # below for no pair warp.
        # img_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "youtube_vis_2019_out_no_pair_warp"),"img_out")
        # reid_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "youtube_vis_2019_out_no_pair_warp"),"reid_out")
        # json_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "youtube_vis_2019_out_no_pair_warp"),"coco_json_out")
        
        # below for pair warp.
        img_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "youtube_vis_2019_out_pair_warp"),"img_out")
        reid_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "youtube_vis_2019_out_pair_warp"),"reid_out")
        json_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "youtube_vis_2019_out_pair_warp"),"coco_json_out")
        
        # below for debug.
        # img_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "debug_only"),"img_out")
        # reid_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "debug_only"),"reid_out")
        # json_output_dir = os.path.join(seq_one_path_out_folder.replace("youtube_vis_2019", "debug_only"),"coco_json_out")
