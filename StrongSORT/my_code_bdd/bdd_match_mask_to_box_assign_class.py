...
if __name__=="__main__":
    ...
    mask_det_min_conf=0.6
    val_in_trainval_seqmap=list(range(1,33))
    # cat={'pedestrian':1,'rider':2,'car':3,'truck':4,'bus':5,'motorcycle':7,'bicycle':8}
    cat={'bus':5}
    folder_prefix="../my_data_bdd/reid_one_class_infer_bdd_pair_warp_right_track_reid_eval_in_train/COCO_pretrain_strong/iter_21k_seq_shuffle_fl_2_lr_0_001_bs_4_eval_500_no_color_sim/BoxInst_MS_R_50_1x_kitti_mots/"
    iter_num="iter_0014999/"
    track_txt_dir=folder_prefix+"results_mot/"+iter_num+"DeepSORT/min_det_conf_04/"
    # mask_txt_dir=folder_prefix+"to_mots_txt/"+iter_num+"mots_det_seg/val_in_trainval/"
    # out_dir=folder_prefix+"to_mots_txt/"+iter_num+"mots_seg_track/DeepSORT/val_in_trainval/mask_min_det_conf_04_bus_conf_06/"
    # below for shadow.
    mask_txt_dir=folder_prefix+"to_mots_txt/"+iter_num+"mots_det_seg/val_in_trainval/shadow_filter_result_rate_02_car_truck/"
    out_dir=folder_prefix+"to_mots_txt/"+iter_num+"mots_seg_track/DeepSORT/val_in_trainval/mask_min_det_conf_04_bus_conf_06/shadow_filter_result_rate_02_car_truck/"
