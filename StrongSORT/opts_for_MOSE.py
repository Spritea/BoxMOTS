...
class opts:
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            default='my_data_for_MOSE_track_result/MOSE_car_seq_out_no_pair_warp/valid_car_seq/reid_np/car'
        )
        self.parser.add_argument(
            '--dir_save',
            # default='results/StrongSORT_Git/tmp'
            default='my_data_for_MOSE_track_result/MOSE_car_seq_out_no_pair_warp/valid_car_seq/results_mot/DeepSORT/min_det_conf_06_max_age_70_max_cos_0.6_no_kalman_gate/car'
        )
        self.parser.add_argument(
            '--EMA_alpha',
            default=0.9
    ...
    def parse(self, args=''):
        ...
        # )
        opt.dir_dataset="my_data_for_MOSE/MOSE_valid_car_seq"
        # opt.dir_dataset="dataset/BDD_MOTS/val_set"
        # below add by cws.
        os.makedirs(opt.dir_save,exist_ok=True)
        return opt

# below add MOSE seqs to the data dict.
def load_txt(file_name):
    with open(file_name,'r') as f:
        txt_content=f.read().splitlines()
    return txt_content
valid_seqs_txt = "my_code_for_MOSE/search_result/valid_car_seq.txt"
train_seqs_txt = "my_code_for_MOSE/search_result/train_car_seq.txt"
data['MOSE'] = {}
data['MOSE']['valid'] = load_txt(valid_seqs_txt)
data['MOSE']['train'] = load_txt(train_seqs_txt)
