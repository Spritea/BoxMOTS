...
if __name__=='__main__':
    ...
    parser.add_argument('--txt_folder',type=str,required=True)
    ...
    # txt_folder = '../my_data_bdd/reid_one_class_infer_for_train/repeat_results/long_epoch_seq_shuffle_fl_2_lr_0_0001_eval_500_steps_4k/CondInst_MS_R_50_1x_kitti_mots/to_mots_txt/iter_0020999/mots_seg_track/DeepSORT/val_set/mask_min_det_conf_04/all_class_no_overlap/'
    # json_out_path = '../my_data_bdd/reid_one_class_infer_for_train/repeat_results/long_epoch_seq_shuffle_fl_2_lr_0_0001_eval_500_steps_4k/CondInst_MS_R_50_1x_kitti_mots/to_mots_txt/iter_0020999/mots_seg_track/DeepSORT/val_set/mask_min_det_conf_04/all_class_no_overlap_json_file/seg_track_pred.json'
