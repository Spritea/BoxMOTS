# @File: StrongSORT/my_code_for_ytvis_2019/ytvis_match_mask_to_box_w_score_kitti_train.py 
# @Author: cws 
...
# Based on: my_code_for_ytvis_2019/ytvis_match_mask_to_box_w_score.py.
...
if __name__=="__main__":
    ...
    val_selected_seqmap=["0b97736357", "1f1396a9ef", "4b1a561480", "06a5dfb511", "7a72130f21",
                            "30fe0ed0ce", "69c0f7494e", "b4e75872a0", "b005747fee", "bbbcd58d89",
                            "d1dd586cfd", "fb104c286f"]
    
    cat = {"person":1}
    
    track_txt_dir="../my_data_for_ytvis_2019_kitti_pretrain_track_result/use_kitti_pretrain_model_selected_videos/youtube_vis_2019_out_pair_warp/valid_for_VIS/combined_result_all_videos/results_mot/DeepSORT/min_det_conf_04_max_cos_0.6_no_kalman_gate/"
    mask_txt_dir="../my_data_for_ytvis_2019_kitti_pretrain_track_result/use_kitti_pretrain_model_selected_videos/youtube_vis_2019_out_pair_warp/valid_for_VIS/combined_result_all_videos/to_mots_txt/mots_det_seg/"
    out_dir="../my_data_for_ytvis_2019_kitti_pretrain_track_result/use_kitti_pretrain_model_selected_videos/youtube_vis_2019_out_pair_warp/valid_for_VIS/combined_result_all_videos/to_mots_txt/mots_seg_track_w_mask_score/DeepSORT/mask_min_det_conf_04_min_det_conf_04_max_cos_0.6_no_kalman_gate/"
    for cat_choose in cat.keys():
        os.makedirs(out_dir+cat_choose,exist_ok=True)
        for seq_id in tqdm(val_selected_seqmap):
