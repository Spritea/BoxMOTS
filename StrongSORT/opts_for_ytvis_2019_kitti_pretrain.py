...
class opts:
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            default="my_data_for_ytvis_2019_kitti_pretrain_track_result/use_kitti_pretrain_model_selected_videos/youtube_vis_2019_out_pair_warp/valid_for_VIS/combined_result_all_videos/reid_np/person"
        )
        self.parser.add_argument(
            '--dir_save',
            # default='results/StrongSORT_Git/tmp'
            default='my_data_for_ytvis_2019_kitti_pretrain_track_result/use_kitti_pretrain_model_selected_videos/youtube_vis_2019_out_pair_warp/valid_for_VIS/combined_result_all_videos/results_mot/DeepSORT/min_det_conf_04_max_cos_0.6_no_kalman_gate/person'
        )
        self.parser.add_argument(
            '--EMA_alpha',
            default=0.9
...
# below add selected ytvis 2019 valid seqs to the data dict.
data['YouTube_VIS_2019'] = {}
data['YouTube_VIS_2019']['valid_selected'] = ["0b97736357", "1f1396a9ef", "4b1a561480", "06a5dfb511", "7a72130f21",
